...
const Footer = () => (
	<div>
        <footer>
            <a href="http://www.lizagne.uk" className="footer" target="_blank" rel="noopener noreferrer"><i className="fa fa-external-link-square" aria-hidden="true"></i> Liz Verde</a>
